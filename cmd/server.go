...
var (
	...
	netnameFlag  = flag.String("faucet.name", "devnet", "Network name to display on the frontend")
	symbolFlag   = flag.String("faucet.symbol", "VLDM", "Token symbol to display on the frontend")
